 ...
 * @param {number} butterItemQuantity butter items quantity on the basket.
 * @param {number} beardItemQuantity beard items quantity on the basket.
 ...
 * @param {Object[]} itemsArray array of object added to the basket.
 * @returns Object with subTotal, discount, and total keys.
 */
export const calculateStatememnt = (itemsArray) => {
  let subTotal = 0;
  let discount = 0;
  let total = 0;
